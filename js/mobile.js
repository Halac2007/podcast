...
let pre = audioPlayer.querySelector('.prev')
let next = audioPlayer.querySelector('.next')

let imgcontainer = audioPlayer.querySelector('.img-container')
...
function togglePlay() {
  if (player.paused) {
    ...
    audioPlayer.classList.add('bemai')
    player.play()
  } else {
    playPause.attributes.d.value = 'M18 12L0 24V0'
    audioPlayer.classList.remove('bemai')
    player.pause()
  }
}
